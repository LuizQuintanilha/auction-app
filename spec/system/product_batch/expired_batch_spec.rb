...
describe 'From the homepage' do
  it 'admin view the expreds batches' do
    ...
    ProductBatch.skip_callback(:save, :before, :date_validator)
    lote = ProductBatch.create!(admin_id: 1, created_by: admin, code: 'ACB112233', start_date: 3.day.ago, 
                            ...
                            minimal_difference: 50, start_time: 1.hour.ago, end_time: 2.hour.ago, approved_by: luiz)
    ProductBatch.set_callback(:save, :before, :date_validator)
